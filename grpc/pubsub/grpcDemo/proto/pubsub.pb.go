...
func (x *StringPub) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StringPub) ProtoMessage() {}

func (x *StringPub) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_proto_msgTypes[0]
...
// Deprecated: Use StringPub.ProtoReflect.Descriptor instead.
func (*StringPub) Descriptor() ([]byte, []int) {
	return file_pubsub_proto_rawDescGZIP(), []int{0}
}

func (x *StringPub) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x21, 0x0a, 0x09, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x50,
	0x75, 0x62, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x6c, 0x69, 0x73, 0x68, 0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72,
	0x69, 0x6e, 0x67, 0x50, 0x75, 0x62, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x50, 0x75, 0x62, 0x12, 0x31, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x73,
	0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x50, 0x75, 0x62, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x50, 0x75, 0x62, 0x30, 0x01, 0x42, 0x08, 0x5a, 0x06, 0x2f,
...
var file_pubsub_proto_goTypes = []interface{}{
	(*StringPub)(nil), // 0: proto.StringPub
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: proto.PubsubService.Publish:input_type -> proto.StringPub
	0, // 1: proto.PubsubService.Subscribe:input_type -> proto.StringPub
	0, // 2: proto.PubsubService.Publish:output_type -> proto.StringPub
	0, // 3: proto.PubsubService.Subscribe:output_type -> proto.StringPub
...
type PubsubServiceClient interface {
	// 发布是rpc的普通方法
	Publish(ctx context.Context, in *StringPub, opts ...grpc.CallOption) (*StringPub, error)
	// 订阅则是一个单向的流服务，服务端返回的数据可能很大
	Subscribe(ctx context.Context, in *StringPub, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error)
}
...
func (*UnimplementedPubsubServiceServer) Publish(context.Context, *StringPub) (*StringPub, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (*UnimplementedPubsubServiceServer) Subscribe(*StringPub, PubsubService_SubscribeServer) error {
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PubsubServiceServer).Publish(ctx, req.(*StringPub))
	}
...
func (x *pubsubServiceSubscribeServer) Send(m *StringPub) error {
